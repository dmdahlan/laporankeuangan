...
class Migrateauth extends Migration
{
    public function up()
    {
        // Users
        ...
        $fields = [
            ...
            'jns_menu'              => ['type' => 'varchar', 'constraint' => 255, 'null' => true],
            'icon'                  => ['type' => 'varchar', 'constraint' => 100, 'null' => true],
            'background'            => ['type' => 'varchar', 'constraint' => 100, 'null' => true],
            'parameter'             => ['type' => 'varchar', 'constraint' => 100, 'null' => true],
