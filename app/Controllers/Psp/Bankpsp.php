...
class Bankpsp extends ResourceController
{
    ...
    public function index()
    {
        ...
        return view('psp/data/v_bankpsp', $data);
    }
    public function showdata()
    {
        $data = $this->transaksiModel->DataTableBank();
    ...
    public function create()
    {
        if ($this->request->isAJAX()) {
            ...
            $bank = $spreadsheet->getSheetByName('bank')->toArray();
    ...
    public function edit($id = null)
    {
        if ($this->request->isAJAX()) {
            ...
            $output = [
                'ok'            => view('psp/edit/e_bankpsp', $data),
                'csrfToken'     => csrf_hash(),
            ];
            echo json_encode($output);
        } else {
    ...
    public function deleteAll()
    {
        if ($this->request->isAJAX()) {
            ...
            try {
                // $this->transaksiModel->deletedId($id);
                $this->transaksiModel->where('inputan', 'bank')->delete();
                $output = [
                    'ok'         => 'data berhasil dihapus',
                    'csrfToken'  => csrf_hash()
                ];
